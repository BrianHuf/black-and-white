...
public class MctsTester {
    ...
    public void ticTacToe() {
        ...
        Move best1 = mcts.findBestMove(game.getLastMove());
        assertEquals("Center is best to start, but this was the selected " + best1.toString(), "X4 -- ____X____",
                best1.toString());

        Move best2 = mcts.findBestMove(best1);
        assertTrue("Corner is best second move, but this was the selected " + best2.toString(),
                isCornerO(best2.toString()));
    ...
    public void ticTacToeTakeWinning() {
        ...
        Move best1 = mcts.findBestMove(game.getLastMove());
        assertEquals("Take a winning move is best, but something else was selected " + best1.toString(),
                "X2 -- XXXOO____", best1.toString());
    }
    ...
    public void ticTacToeBlockWinning() {
        ...
        Move best1 = mcts.findBestMove(game.getLastMove());
        assertEquals("Blocking a winner is best, but something else was selected " + best1.toString(),
                "O2 -- XXOO_____", best1.toString());
    }
    ...
    private void assertFinalTie(AI ai, Game game) {
        ...
        assertTrue(
                "Thoughtful games end in tie, but this move won... " + finalMove.toString() + " -- " + game.toString(),
                finalMove.getStatus().isTie());
    }
